...
Config::Config()
{
	...
	// _countof, not sizeof - the API takes the buffer length in wchar_t's, and sizeof returns bytes.
	DWORD len = GetModuleFileNameW(HINST_THISCOMPONENT, buffer, _countof(buffer));

...
// Note: only WRL is needed here (for ComPtr). Don't add <atlbase.h> - ATL is a separate, optional
// Visual Studio component that isn't present in a plain Build Tools install, and nothing in this
// header or its users needs it. The ATL-using code (dx10compositor, VRKeyboard) includes it itself
// from inside the #ifdefs that gate that code.

...
private:
	...
	// Must start above zero, since the fences are created with an initial value of zero - otherwise the
	// first WaitForFence call would be comparing against an already-signalled value.
